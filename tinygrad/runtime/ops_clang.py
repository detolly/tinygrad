...
from tinygrad.renderer.cstyle import ClangRenderer, ClangRendererOSX
...
class ClangDevice(Compiled):
  def __init__(self, device:str):
    ...
    if OSX: super().__init__(device, MallocAllocator, ClangRendererOSX(), ClangCompilerOSX(), ClangProgramOSX, ClangGraphOSX)
